## Use collector.py instead,
## this version with original
## intended functoinality
## did not play nice with Windows imposed security settings
## (namely, AppData as a junction point)
